    ...
    <section className='section'>
      <div className='center-element'>
        ...
        <ul className={'mx-auto max-w-md md:max-w-xl text-justify'}>
          <li className='mb-2' data-aos='zoom-in' data-aos-duration='700'>
            <p>
          ...
          <li data-aos='zoom-in' data-aos-duration='700'>
            <p>
              <strong>Stewardship</strong> - the ability to govern and uphold
              the principles and the moral standards of students in particular
              and the academic institution in general.
            </p>
          </li>
        </ul>
      </div>
